...
// Front Right Wheel Collider  => collider0
// Front Left Wheel Collider   => collider1
// Rare Right Wheel Collider   => collider2
// Rare Left Wheel Collider    => collider3
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public class CarController : MonoBehaviour {
    ...
    void ApplyMotorPower() {
        wheelColliders.FLWheel.motorTorque = motorPower * forwardInput;
        wheelColliders.FLWheel.motorTorque = motorPower * forwardInput;
    ...
    void HandleSteering() {
        ...
        float finalTurnRadius = (turnRadius > 5 ) ? turnRadius : 5  ;
        
        if (steeringInput > 0 ) {
            //rear tracks size is set to 1.5f       wheel base has been set to 2.55f
            wheelColliders.FRWheel.steerAngle = Mathf.Rad2Deg * Mathf.Atan(2.55f / (finalTurnRadius - (1.5f / 2))) * steeringInput;
            wheelColliders.FLWheel.steerAngle = Mathf.Rad2Deg * Mathf.Atan(2.55f / (finalTurnRadius + (1.5f / 2))) * steeringInput;
            ...
            wheelColliders.FRWheel.steerAngle =0;
            wheelColliders.FLWheel.steerAngle =0;
        }
    }
